...
<body>
    ...
    <div class="content">
        <div class="container">
            <h1>Letter In</h1>
            <form method="post" action="/letter-in">
    <input type="text" name="title" placeholder="Letter Title" required><br>
    <textarea name="sender_address" placeholder="Sender Address" required></textarea><br>
    <textarea name="receiver_address" placeholder="Receiver Address" required></textarea><br>

    <?php if ($userType !== 'normal'): ?>
    <div class="radio-buttons">
        <label class="custom-radio">
            <input type="radio" name="letter_type" value="Added" required>
            <span class="radio-label">Added</span>
        </label>
        <label class="custom-radio">
            <input type="radio" name="letter_type" value="Letter In">
